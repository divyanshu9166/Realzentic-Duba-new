...
# professional English; a bilingual Arabic experience can be added only after a
# voice vendor and reviewed Arabic prompts are selected.
...
# Keep Sarvam configurable for existing deployments, but use English until an
# English/Arabic UAE voice provider is configured and tested.
DEFAULT_TTS_PROVIDER = "sarvam"
DEFAULT_TTS_VOICE = os.getenv("SARVAM_TTS_SPEAKER", "anushka")
SARVAM_MODEL = os.getenv("SARVAM_TTS_MODEL", "bulbul:v3")
SARVAM_LANGUAGE = os.getenv("SARVAM_TTS_LANGUAGE", "en")
